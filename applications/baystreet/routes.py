...
routes_in = (
  ('/baystreet/schedule/schedule_file.ics', '/baystreet/schedule/schedule_file'),
  ('/baystreet', '/baystreet/schedule/')
)
routes_out = (
  ('/baystreet/schedule/schedule_file', '/baystreet/schedule/schedule_file.ics'),
)
